...
mod tests {
    use super::*;
    use inkwell::context::Context;
    use crate::ast::{Type, Mutability, Span, BinaryOp};
    ...
    fn get_ir_from_source(context: &Context, source: &str) -> Result<String, Box<dyn std::error::Error>> {
    ...
    fn test_generate_if_stmt() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let if_stmt = HirStmt::If {
            ...
            capture: None,
            then_branch: Box::new(HirStmt::Return(Some(HirExpr::Int(1, Type::I64, Span::default())), Span::default())),
            else_branch: Some(Box::new(HirStmt::Return(Some(HirExpr::Int(0, Type::I64, Span::default())), Span::default()))),
            span: Span::default(),
        };
    ...
    fn test_generate_return_stmt() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let ret_stmt = HirStmt::Return(Some(HirExpr::Int(123, Type::I64, Span::default())), Span::default());
    ...
    fn test_generate_member_assign_stmt() -> Result<(), Box<dyn std::error::Error>> {
        ...
        codegen.variable_types.insert("p".to_string(), Type::Custom { name: "Point".to_string(), generic_args: vec![], is_exported: false });
        ...
        let switch_stmt = HirStmt::Switch {
            ...
            cases: vec![
                crate::hir::HirCase {
                    ...
                    body: HirStmt::Return(Some(HirExpr::Int(10, Type::I64, Span::default())), Span::default()),
                    span: Span::default(),
                },
                crate::hir::HirCase {
                    patterns: vec![HirExpr::Ident("_".to_string(), Type::I64, Span::default())],
                    body: HirStmt::Return(Some(HirExpr::Int(20, Type::I64, Span::default())), Span::default()),
                    span: Span::default(),
                },
            ],
            span: Span::default(),
    ...
    fn test_generate_break_stmt() -> Result<(), Box<dyn std::error::Error>> {
        ...
        let break_stmt = HirStmt::Break { label: None, span: Span::default() };
